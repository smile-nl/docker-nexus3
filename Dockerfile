...
MAINTAINER TubbyNL <https://github.com/tubbynl>
# due to less active support from SonaType 
# mostly based on https://github.com/sonatype/docker-nexus3

ENV NEXUS_DATA /nexus-data

ENV NEXUS_VERSION 3.0.1-01

# install yum and Oracle JRE is omitted (openjdk is used)
